...
data BuiltinFunction (s :: [BuiltinType]) (t :: BuiltinType) where
  ...
  IfThenElse :: BuiltinFunction '[BTBool, a, a] a
  ChooseUnit :: BuiltinFunction '[BTUnit, a] a
  Trace :: BuiltinFunction '[BTString, a] a
...
data BuiltinPairFunction (s :: [BuiltinType]) (t :: BuiltinType) where
  FstPair :: BuiltinPairFunction '[BTPair t u] t
  SndPair :: BuiltinPairFunction '[BTPair t u] u

data BuiltinListFunction (s :: [BuiltinType]) (t :: BuiltinType) where
  ChooseList :: BuiltinListFunction '[BTList t, u, u] u
...
data BuiltinDataFunction (s :: [BuiltinType]) (t :: BuiltinType) where
  ChooseData :: BuiltinDataFunction '[BTData, t, t, t, t, t] t
