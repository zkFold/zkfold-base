...
class
  ( FiniteField (BaseField curve),
    ...
    ToByteString (BaseField curve),
    Haskell.Show (ScalarField curve),
    Haskell.Num (ScalarField curve),
    Haskell.Ord (ScalarField curve),
    PrimeField (ScalarField curve),
...
class
  ( EllipticCurve curve1,
    EllipticCurve curve2,
    ScalarField curve1 ~ ScalarField curve2,
    Eq t,
