...
import           ZkFold.Base.Algebra.Basic.Number                    (KnownNat, value, Natural)
...
import           ZkFold.Base.Protocol.Plonkup.Internal               (PlonkupPolyExtendedLength, PlonkupPolyExtended)
