...
solder f = fold (arithmetize f $ circuits $ replicateA (inputSize @a @f) input)

-- | Compiles function `f` into an arithmetic circuit.
compile :: forall a f. Arithmetizable a f => f -> ArithmeticCircuit a
compile f = optimize (solder f)
