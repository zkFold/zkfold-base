...
examples =
  ...
  , ("ByteString.Rotate5.64", exampleOutput $ exampleByteStringRotate5 @64)
  , ("UInt.Rotate5.64", exampleOutput $ exampleUIntRotate5 @64 @Auto)
  , ("ByteString.Or.64", exampleOutput $ exampleByteStringOr @64)
  , ("ByteString.Xor.64", exampleOutput $ exampleByteStringXor @64)
  , ("UInt.Xor.64", exampleOutput $ exampleUIntXor @64 @Auto)
  ...
  , ("ByteString.Extend.50.64", exampleOutput $ exampleByteStringExtend @50 @64)
  , ("UInt.Resize.50.64", exampleOutput $ exampleUIntResize @50 @64 @Auto)
  , ("UInt.Resize.64.50", exampleOutput $ exampleUIntResize @64 @50 @Auto)
  ...
  , ("ByteString.Iso.64", exampleOutput $ exampleByteStringIso @64 @Auto)
  , ("UInt.Iso.64", exampleOutput $ exampleUIntIso @64 @Auto)
