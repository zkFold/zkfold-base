...
examples =
  ...
  , ("ByteString.Truncate.512.1", exampleOutput $ exampleByteStringTruncate @512 @1)
  , ("UInt.Shrink.512.1", exampleOutput $ exampleUIntShrink @512 @1 @Auto)
  , ("ByteString.Truncate.74.54", exampleOutput $ exampleByteStringTruncate @74 @54)
  , ("UInt.Shrink.74.54", exampleOutput $ exampleUIntShrink @74 @54 @Auto)
